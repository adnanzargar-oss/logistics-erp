...
export default function Login() {
 ...
 <div className="absolute inset-0 bg-gradient-to-br from-[#2c2660] via-[#ef453c] to-[#2c2660] bg-[length:200%_200%] animate-gradient z-0" />
 <div className="absolute inset-0 bg-[#f1f2f3]/80 z-0" />
 ...
 <h1 className="text-lg font-bold text-gray-900 ">Planet Transport Pvt Ltd.</h1>
 <p className="text-xs text-gray-500 ">Tengpora Bypass, Srinagar</p>
 </div>
 ...
 stage.done ? 'bg-green-500 text-white' : 'bg-gray-100 text-gray-400'
 }`}>
 {stage.done ? <CheckCircle2 size={14} /> : <Icon size={14} />}
 </div>
 {!isLast && <div className={`h-0.5 flex-1 mx-0.5 ${stage.done ? 'bg-green-500' : 'bg-gray-200 '}`} />}
 </div>
 );
 })}
 </div>
